const messagesInuarainian = {
  ...
  POSITION: {
    EMPLOYER: 'Будь ласка, вкажіть яку позицію в компанії ви займаєте',
    WORKER: 'Будь ласка, вкажіть на яку позицію ви претендуєте'
  },
  ENGLISH_LEVEL: {
  ...
  TEMPORARY_USER: {
    ...
    EXIST_ACC: 'Обліковий запис вже зареєстровано'
  },
  DEFAULT_BUTTON: {
    EDIT: 'Редагувати ✏️',
    BACK: 'Назад ⬅️',
